...
module.exports = function fnAgg(agg, stateAgg, pin, bld, obj, s, acc) {
	...
	for (const cmpr of agg.compressorList) {
		// console.log(111, 'Агрегат', agg.name, agg._id, JSON.stringify(stateAgg))
