...
const dict = {
	...
	4: 'Низкая температура канала',
	5: 'переключатель на щите',
	6: 'работает удаление СО2',
	7: 'не выбран авторежим и(или) продукт, нет настроек',
	8: 'склад выключен',
	9: 'секция не в авто',
	10: 'задание продукта еще не достигнуто', //комби-холодильник
	11: 'настройка "Вентиляция": работа внутренней вентиляции = 0', //комби-обычный
	12: 'настройка "Вентиляция": работа внутренней вентиляции = 0', //обычный склад
	13: 'склад работает по авто режиму', //комби-обычный, хранение
	14: 'склад работает по авто режиму', //обычный, хранение
